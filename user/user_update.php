...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    echo "<div class='text-center mt-3'><a href='user_table.php' class='btn btn-primary'>Back to Records</a></div>";
    exit;
}
    ...
    <div class="container mt-5 d-flex justify-content-center">
        <div class="card shadow-lg p-4 rounded-4" style="max-width: 500px; width: 100%;">
            ...
            <div class="text-center mt-3">
                <a href="user_table.php" class="btn btn-outline-secondary">Back to Records</a>
            </div>
        </div>
    </div>
</body>
