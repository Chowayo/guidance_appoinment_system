...
<nav class="navbar navbar-expand-lg px-4">
  <a class="navbar-brand fst-italic" href="#"><img src="logo.jpg" alt="Logo" class="logo-navbar me-2">EVERGREEN INTEGRATED HIGHSCHOOL</a>
  <div class="ms-auto">
...
$(document).ready(function(){
  ...
  Swal.fire({
    ...
    if(result.isConfirmed){
      window.location.href = "user_update.php?student_id=" + student_id;
    }
  });
});
